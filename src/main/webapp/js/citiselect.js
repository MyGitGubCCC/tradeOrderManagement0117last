         ...
         $.extend({
                 citySelect: function (settings) {
                     ...
                     var getObjs = function (v) {
                             var str = "0";
                             for (var i = 0; i < v; i++) { str += ("_" + (s[i].combobox('getIndex'))); }
                             ;
                             if (dsy.Exists(str)) {
                                     ar = dsy.Items[str];
                                         ...
                                         if (newValue != "" && objs.length) {
                                                 var city = $city.combobox({
                                                         ...
                                                         onLoadSuccess: function () { //第2选中
                                                             ...
                                                             $city.combobox('setText', combobox[0].text).combobox('setValue', combobox[0].text);
                                                         },
                                                     onChange: function (newValue, oldValue) {
                                                             var objs = getObjs(2);
                                                             if (newValue != "" && objs.length) {
                                                                     ...
                                                                     $County.combobox({
                                                                             ...
                                                                             onLoadSuccess: function () { //第2选中
                                                                                 ...
                                                                                 $County.combobox('setText', combobox[0].text).combobox('setValue', combobox[0].text);
                                                                             }
                     ...
                     dsy.add("0_19_0", ["越秀区", "荔湾区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "花都区", "南沙区", "萝岗区", "增城区", "从化区"]);
