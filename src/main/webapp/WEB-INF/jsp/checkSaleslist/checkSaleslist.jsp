...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/checkSaleslist-js.js" ></script>
    <%--省市区联动js--%>
...
<div region="center" fit="true" title="销售清单列表" >
    <div id="tb">
        销售清单：<input class="easyui-textbox" name="consigneeno" id="consigneenodel" style="width:150px;"/>
        <%--处理状态：
        <input id="orderstatus111" class="easyui-combobox" name="orderstatus111"
               data-options="valueField:'id',textField:'text',url:'js/dingdanchulizhangtai.json'">--%>
    ...
    <form id="fm" method="post">
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr >
                ...
                <td>
                    <input readonly="readonly" required="true"style="width:auto;" name="employeeName" id="employeeName" value=""/>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveUser(4)">同意</a>
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" onclick="closeDialog()">返回</a>
</div>
