...
<body>
<table width="100%" data-toggle="topjui-datagrid"
       data-options="id: 'productDg',
            url: '${pageContext.request.contextPath}/selectDepartment.action',
            filter: [{
                field: 'name',
                type: 'textbox',
    ...
    <thead>
    <tr >
        <th data-options="field:'departmentid',title:'UUID',checkbox:true" ></th>
        <th data-options="field:'departmentno',title:'部门编号',sortable:true" style="width:30%"></th>
        <th data-options="field:'departmentname',title:'部门名称',sortable:true" width="30%"></th>
        <th data-options="field:'description',title:'部门描述',sortable:true" width="30%"></th>
    </tr>
    </thead>
</table>
...
<div id="productDg-toolbar" class="topjui-toolbar"
    ...
    <a href="javascript:void(0)"
       ...
       data-options="event:'openDialog',
            ...
            dialog: {
                width: 950,
                height: 500,
                href:'${pageContext.request.contextPath}/editDepartment.jsp?uuid={departmentid}',
    ...
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="event:'doAjax',btnCls:'topjui-btn-normal',
       iconCls:'fa fa-trash',
    ...
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="event:'search',btnCls:'topjui-btn-danger'">查询</a>
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="event:'import',
    ...
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="event:'openWindow',btnCls:'topjui-btn-warm',
       href:'http://www.topjui.com?uuid={uuid}'">打开新窗口</a>
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
       data-options="event:'request',
       btnCls:'topjui-btn',
       url:_ctx + '/json/response/success.json?uuid={uuid}&code={code}'">执行普通请求</a>
    <a href="javascript:void(0)"
       data-toggle="topjui-menubutton"
