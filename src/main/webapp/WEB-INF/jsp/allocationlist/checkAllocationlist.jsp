...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/checkAllocationlist-js.js" ></script>
    <%--省市区联动js--%>
    ...
    <div>
        <table id="departmentsdg" class="easyui-datagrid" toolbar="#tb" style="width:100%;height: auto;"
            ...
            <tr>
                ...
                <th data-options="field:'ordertime'" width="15%" align="center">提交时间</th>
                ...
                <%--<th data-options="field:'orderstatus2'" width="10%" align="center">处理状态</th>--%>
    ...
    <form id="fm" method="post">
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" readonly="readonly" name="transfertime" id="transfertime" data-options="multiline:true" value="" style="width:100%;height:100%;">
                </td>
                <td  colspan="2"></td>
            </tr>
            <tr>
                ...
                <td  colspan="5">
                    <input class="easyui-textbox" readonly="readonly" name="comment" id="comment" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <label >配拨商品</br>名称：</label>
                </td>
                <td>
                    <input type="hidden" readonly="readonly" required="true" name="employeeid22" id="employeeid22" value="${sessionScope.get('employee').employeeid}"/>
                    <input type="hidden"class="easyui-textbox" readonly="readonly"   name="employeeName22" id="employeeName22" value="${sessionScope.get('employee').name}"/>
                    <input type="hidden" readonly="readonly" required="true" name="allocationlistid" id="allocationlistid" value=""/>
                    <input  readonly="readonly" id="commodityname2" class="easyui-combobox" name="commodityname2"
                           data-options="valueField:'id',textField:'text',url:'js/commodity.json'">
                </td>
                <td>
                    <label > 配拨数量：</label>
                </td>
                <td>
                    <input readonly="readonly" class="easyui-numberspinner" id="ammount2" name="ammount2" data-options="min:1,max:100,required:true" style="width:100%;"/>
                </td>
                <td colspan="2"></td>
            </tr>
            <tr>
                <td>
                    <label>业管单位</br>配拨说明：</label>
                </td>
                <td colspan="5">
                    <input readonly="readonly" class="easyui-textbox" name="allocationopinion" id="allocationopinion" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveUser(10)">提交</a>
