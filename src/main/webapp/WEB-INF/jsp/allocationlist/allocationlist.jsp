...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/allocationlist-js.js" ></script>
    <%--省市区联动js--%>
        ...
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden" readonly="readonly" required="true" name="applytransferformid" id="applytransferformid" value=""/>
                    <input id="commodityname2" class="easyui-combobox" name="commodityname2"
                ...
                <td>
                    <input class="easyui-numberspinner" id="ammount2" name="ammount2" data-options="min:1,max:100,required:true" style="width:100%;"/>
                </td>
                <td colspan="2"></td>
            </tr>
            <tr>
                ...
                <td colspan="5">
                    <input class="easyui-textbox" name="allocationopinion" id="allocationopinion" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveUser(9)">提交</a>
