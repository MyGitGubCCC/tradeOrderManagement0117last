...
<style type="text/css">
    ...
    .text_over {
        ...
        -moz-binding: url('${pageContext.request.contextPath}/ellipsis.xml#ellipsis');
    }
...
<div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
        ...
        <table style="float:left;border-spacing:0px;">
            <tr>
                <td class="webname">
                    <span class="fa fa-envira" style="font-size:26px; padding-right:8px;"></span>贸易订单管理系统
                </td>
                    ...
                    <table id="topmenucontent" cellpadding="0" cellspacing="0">
                        <td id="1325" title="这只是静态演示" class="topmenu selected systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                ...
                                <p><span style="white-space:nowrap;">管理</span></p>
                            </a>
                        </td>
                        ...
                        <td id="test1" title="人力资源" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                        ...
                        <td id="test2" title="系统设置" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                        ...
                        <h3>
                            <a id="showUserInfo" style="display:inline-block;" class="fa bannerbtn"
                               href="javascript:void(0)">
                                <img src="${pageContext.request.contextPath}/topjui/image/avatar.jpg" class="user-image" alt="User Image">
    ...
    <div id="center" data-options="region:'center',border:false" style="overflow:hidden;">
        <div id="index_tabs" style="width:100%;height:100%">
            ...
            content:'<iframe src=\'${pageContext.request.contextPath}/tradeOrderMainInfo.action\' scrolling=\'auto\' frameborder=\'0\' style=\'width:100%;height:100%;\'></iframe>'"></div>
        </div>
    </div>
    ...
    <div data-options="region:'south',border:true"
        ...
        <span style="float:left;padding-left:5px;width:30%;text-align: left;">当前用户：${name}</span>
        <span style="padding-right:5px;width:40%">
            版权所有 © 2018-2018
            <a href="#" target="_blank">软件项目设计II第7小组</a>
        </span>
        <span style="float:right;padding-right:5px;width:30%;text-align: right;">版本：1.0.0</span>
    </div>
</div>
...
<%--<form id="pwdDialog"
      ...
      width: 400,
      height: 300,
      href: '${pageContext.request.contextPath}/modifyPassword.action'"></form>--%>

<form id="pwdDialog" data-options="title: '修改密码',
      iconCls:'fa fa-key',
      width: 400,
      height: 300">
    <style>
    ...
    <table class="editTable">
        <tr>
            ...
            <td><input type="text" id="employeeno" name="employeeno" value="${employeeno}"></td>
        </tr>
        <tr>
