...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/saleslistxiaoshou-js.js" ></script>
    <%--省市区联动js--%>
    ...
    <form id="fm" method="post">
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    <input id="memberId" style="width:150px;"
            ...
            <tr>
                ...
                <td colspan="5">
                    <input class="easyui-textbox"  name="notes" id="notes" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
