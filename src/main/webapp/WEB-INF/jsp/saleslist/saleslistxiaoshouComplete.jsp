...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/saleslistxiaoshouComplete-js.js" ></script>
    <%--省市区联动js--%>
    ...
    <form id="fm" method="post">
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" readonly="readonly"   name="employeeName" id="employeeName" value=""/>
                </td>
                <td>
                    <label>客户资本：</label>
                </td>
            ...
            <tr>
                ...
                <td colspan="5">
                    <input class="easyui-textbox" readonly="readonly" name="customername" id="customername" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr >
                ...
                <td>
                    <input readonly="readonly" required="true"style="width:auto;" name="employeeName1" id="employeeName1" value=""/>
                </td>

                <td>
                    <label>订单状态：[已完成]</label>
                </td>
                <td>
                </td>
                <td>
