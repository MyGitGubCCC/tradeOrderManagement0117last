...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/paymentMethod-js.js"></script>
    <!--引入EasyUI 图标文件-->
...
<div region="center" fit="true" title="学生信息列表" >
    <div id="tb">
        支付名称：<input class="easyui-textbox" name="paymentmethodname" id="paymentmethodname" style="width:150px;height:32px"/>
    ...
    <div data-options="region:'center'" style="padding:5px;background:#eee;width:100%;height: auto;">
        <table id="paymentmethoddata"></table>
    </div>
</div>
        ...
        <table id="datagrid" style="width:auto;height:500px">
            <tr>
                ...
                <td><%--//jsp中的name要与entity中的名称一一对应--%>
                    ...
                    <input type="hidden" readonly="readonly" required="true" name="paymentmethodid" id="paymentmethodid" value=""/>
                    <input class="easyui-textbox" required="true" name="name" id="paymentmethodname1" value=""/>
                </td>
            </tr>
            <tr>
                <td >支付描述：</td>
