...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/applyTransferForm-js.js" ></script>
    <%--省市区联动js--%>
        ...
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="applyArea" class="easyui-combobox" name="applyArea"
                ...
                <td  colspan="3">
                    <input class="easyui-textbox" name="comment" id="comment" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveUser(7)">调配</a>
