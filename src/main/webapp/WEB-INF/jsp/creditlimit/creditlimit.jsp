...
<head>
    ...
    <%--引入自定义的js--%>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/creditlimit-js.js" ></script>
    <%--省市区联动js--%>
    ...
    <form id="fm" method="post">
        <table id="datagrid" style="width:auto;height: auto;">
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-textbox"  name="customercapital" id="customercapital" value=""/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td colspan="5">
                    <input class="easyui-textbox"  name="creditsituationdescription" id="creditsituationdescription" data-options="multiline:true" value="" style="width:100%;height:50px;">
                </td>
            </tr>
        </table>
    </form>
...
<div id="dlg-buttons">
    <a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="saveUser(5)">签注</a>
